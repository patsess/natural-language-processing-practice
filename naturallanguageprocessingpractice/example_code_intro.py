...
if __name__ == '__main__':
    ...
    # Find the script notation at the beginning of the fourth sentence and
    # print it
    pattern2 = r"[\w+\d\s\:]+:"
    ...
    # Zip the feature names together with the coefficient array and sort by
    # weights: feat_with_weights
